...
const pcm                        = Bun.env.AUDIO_FULL === "true" ? new RemotePcmAll(audio_url,prod_pcm_info) : new RemotePcmRange(audio_url,test_pcm_info);
...
const server = Bun.serve({
  ...
  static: {
    ...
    "/client.js": new Response(await Bun.file("./dist/client_bundle.js").bytes(),{
      headers: {
        "Content-Type": "text/javascript",
        'X-Content-Type-Options': 'nosniff'
      }
    }),
    "/maplibre-gl.js": new Response(await Bun.file("./assets/maplibre-gl.js").bytes(),{
      headers: {
        "Content-Type": "text/javascript",
        'X-Content-Type-Options': 'nosniff'
      }
