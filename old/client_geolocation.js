...
async function HandleOutOfBounds() {
	...
	alert("Du befinner dig för långt bortom tidstängslet! ladda om sidan när du befinner på kartan!",);
...
async function HandlePosUpdate(geopos) {
	...
	console.log("within perim: ", inside_perim);
	console.log("within map: ", inside_map);
